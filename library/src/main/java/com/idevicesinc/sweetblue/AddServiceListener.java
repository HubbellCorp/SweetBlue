...
public interface AddServiceListener extends GenericListener_Void<AddServiceListener.ServiceAddEvent>
{
    /**
    ...
    class ServiceAddEvent extends Event
    {
        ...
        public final String toString()
        {
            ...
            (
                this.getClass(),
                "status",			status(),
                "service",          P_Bridge_Internal.serviceName(server().getIBleServer().getIManager(), service().getUuid()),
