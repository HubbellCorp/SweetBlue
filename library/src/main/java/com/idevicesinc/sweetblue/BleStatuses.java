...
public final class BleStatuses
{
	 ...
	 * <br><br>
	 * Also used for {@link DeviceReconnectFilter.ConnectFailEvent#gattStatus()} for when the failure didn't involve the gatt layer.
	 */
	 ...
	 *
	 * Mapped from {@link AdvertiseCallback#ADVERTISE_FAILED_DATA_TOO_LARGE}
	 */
	 ...
	 *
	 * Mapped from {@link AdvertiseCallback#ADVERTISE_FAILED_TOO_MANY_ADVERTISERS}
	 */
	 ...
	 *
	 * Mapped from {@link AdvertiseCallback#ADVERTISE_FAILED_ALREADY_STARTED}
	 */
	 ...
	 *
	 * Mapped from {@link AdvertiseCallback#ADVERTISE_FAILED_INTERNAL_ERROR}
	 */
	 ...
	 *
	 * Mapped from {@link AdvertiseCallback#ADVERTISE_FAILED_FEATURE_UNSUPPORTED}
	 */
	 ...
	 * Maps to {@link BluetoothGattServer#STATE_CONNECTED}
	 */
	public static final int SERVER_CONNECTED		= BluetoothGattServer.STATE_CONNECTED;

	/**
	 * Indicates the server is connecting.
	 * Maps to {@link BluetoothGattServer#STATE_CONNECTING}
	 */
	public static final int SERVER_CONNECTING		= BluetoothGattServer.STATE_CONNECTING;

	/**
	 * Indicates the server is disconnected.
	 * Maps to {@link BluetoothGattServer#STATE_DISCONNECTED}
	 */
	public static final int SERVER_DISCONNECTED		= BluetoothGattServer.STATE_DISCONNECTED;

	/**
	 * Indicates the server is disconnecting.
	 * Maps to {@link BluetoothGattServer#STATE_DISCONNECTING}
	 */
	public static final int SERVER_DISCONNECTING	= BluetoothGattServer.STATE_DISCONNECTING;

	/**
	 * Indicates the device is connected.
	 * Maps to {@link BluetoothProfile#STATE_CONNECTED}
	 */
	public static final int DEVICE_CONNECTED		= BluetoothProfile.STATE_CONNECTED;

	/**
	 * Indicates the device is connecting.
	 * Maps to {@link BluetoothProfile#STATE_CONNECTING}
	 */
	public static final int DEVICE_CONNECTING		= BluetoothProfile.STATE_CONNECTING;

	/**
	 * Indicates the device is disconnected.
	 * Maps to {@link BluetoothProfile#STATE_DISCONNECTED}
	 */
	public static final int DEVICE_DISCONNECTED		= BluetoothProfile.STATE_DISCONNECTED;

	/**
	 * Indicates the device is disconnecting.
	 * Maps to {@link BluetoothProfile#STATE_DISCONNECTING}
	 */
	public static final int DEVICE_DISCONNECTING	= BluetoothProfile.STATE_DISCONNECTING;

	/**
	 * Generic device error.
	 * Maps to {@link BluetoothDevice#ERROR}
	 */
	public static final int DEVICE_ERROR			= BluetoothDevice.ERROR;

	/**
	 * Device is in the process of bonding.
	 * Maps to {@link BluetoothDevice#BOND_BONDING}
	 */
	public static final int DEVICE_BOND_BONDING		= BluetoothDevice.BOND_BONDING;

	/**
	 * Device is currently bonded.
	 * Maps to {@link BluetoothDevice#BOND_BONDED}
	 */
	public static final int DEVICE_BOND_BONDED		= BluetoothDevice.BOND_BONDED;

	/**
	 * Device is not bonded.
	 * Maps to {@link BluetoothDevice#BOND_NONE}
	 */
	public static final int DEVICE_BOND_UNBONDED	= BluetoothDevice.BOND_NONE;

	/**
	 * Indicates a GATT profile
	 * Maps to {@link BluetoothGatt#GATT}
	 */
	public static final int PROFILE_GATT			= BluetoothGatt.GATT;
