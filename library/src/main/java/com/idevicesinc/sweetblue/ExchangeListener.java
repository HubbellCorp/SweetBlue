...
public interface ExchangeListener
{
    ...
    abstract class ExchangeEvent extends Event
    {
         ...
         */
        public final BluetoothDevice nativeDevice()  {  return m_nativeDevice.getDevice();  };
        private final P_DeviceHolder m_nativeDevice;

        final P_DeviceHolder deviceHolder()
        {
        ...
        ExchangeEvent(BleServer server, P_DeviceHolder nativeDevice, UUID serviceUuid_in, UUID charUuid_in, UUID descUuid_in, Type type_in, Target target_in, byte[] data_in, int requestId, int offset, final boolean responseNeeded)
        {
            m_server = server;
