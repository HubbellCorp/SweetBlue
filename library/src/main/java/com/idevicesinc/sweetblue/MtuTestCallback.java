...
public interface MtuTestCallback
{
    ...
    /**
     * This gets called after {@link BleDevice#negotiateMtu(int, ReadWriteListener)} or any of it's overloads is called, and it returns a success. Return a
    ...
    class MtuTestEvent extends Event
    {
         ...
         * {@link BleDevice#negotiateMtu(int)} method.
         */
    ...
    class TestResult
    {
        ...
        TestResult(BleDevice device, Result result, ReadWriteListener.Status writeStatus)
        {
            m_device = device;
            m_result = result;
         ...
         * the {@link com.idevicesinc.sweetblue.ReadWriteListener.Status} from the write which was performed as the test.
         */
    ...
    class Please
    {
        ...
        /**
         * Tell SweetBlue what characteristic it should write to, and provide the data to write. The byte array size should ideally be the size of the newly
         * negotiated MTU size. This also allows you to set the write type -- one of {@link com.idevicesinc.sweetblue.ReadWriteListener.Type#WRITE} (this is the default),
         * {@link com.idevicesinc.sweetblue.ReadWriteListener.Type#WRITE_NO_RESPONSE}, or {@link com.idevicesinc.sweetblue.ReadWriteListener.Type#WRITE_SIGNED}.
         */
        public static Please doWriteTest(@Nullable(Nullable.Prevalence.NORMAL) UUID serviceUuid, @Nullable(Nullable.Prevalence.NEVER) UUID charUuid, @Nullable(Nullable.Prevalence.NEVER) byte[] data, ReadWriteListener.Type writeType)
        {
