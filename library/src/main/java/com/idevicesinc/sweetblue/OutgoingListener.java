...
import com.idevicesinc.sweetblue.ExchangeListener.ExchangeEvent;
...
public interface OutgoingListener extends ExchangeListener, GenericListener_Void<OutgoingListener.OutgoingEvent>
{
    ...
    class OutgoingEvent extends ExchangeEvent implements UsesCustomNull
    {
        ...
        /**
         * The data that was attempted to be sent back to the client if {@link #type()} {@link ExchangeListener.Type#isRead()} is <code>true</code>.
         */
         ...
         * if {@link #type()} is {@link ExchangeListener.Type#READ} or {@link ExchangeListener.Type#WRITE} - otherwise this will equal {@link BleStatuses#GATT_STATUS_NOT_APPLICABLE}.
         */
         ...
         * {@link ExchangeListener.Type#isNotificationOrIndication()} is <code>true</code> - otherwise this will equal {@link BleStatuses#GATT_STATUS_NOT_APPLICABLE}.
         */
        ...
        {
            super(e.server(), e.deviceHolder(), e.serviceUuid(), e.charUuid(), e.descUuid(), e.type(), e.target(), e.data_received(), e.requestId(), e.offset(), e.responseNeeded());
        ...
        static OutgoingEvent EARLY_OUT__NOTIFICATION(final BleServer server, final P_DeviceHolder nativeDevice, final UUID serviceUuid, final UUID charUuid, final FutureData data, final Status status)
        {
        ...
        static OutgoingEvent NULL__NOTIFICATION(final BleServer server, final P_DeviceHolder nativeDevice, final UUID serviceUuid, final UUID charUuid)
        {
    ...
    enum Status implements UsesCustomNull
    {
        ...
        /**
         * For now only relevant if {@link OutgoingEvent#type()} is {@link ExchangeListener.Type#NOTIFICATION} -
