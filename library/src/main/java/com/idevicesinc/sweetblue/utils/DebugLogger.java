...
public final class DebugLogger implements SweetLogger
{
     ...
     * need to have {@link BleManagerConfig#loggingOptions} set to {@link com.idevicesinc.sweetblue.LogOptions#ON}, or {@link com.idevicesinc.sweetblue.LogOptions#ALL_ON}.
     */
    ...
    DebugLogger(boolean unitTest, int maxLogSize, boolean printToLogCat)
    {
        ...
        m_logList = Collections.synchronizedList(new ArrayList<>(maxLogSize));
