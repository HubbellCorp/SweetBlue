...
public final class Uuids
{
	...
	public enum GATTFormatType
	{
		...
		private BigInteger parseHexString(String hexString)
		{
			try
			{
				...
				byte hexBytes[] = Utils_String.hexStringToBytes(hexString);
		...
		private BigInteger parseBinaryString(String binaryString)
		{
			try
			{
				...
				byte binaryBytes[] = Utils_String.binaryStringToBytes(binaryString);
		...
		public byte[] stringToByteArray(String s) throws GATTCharacteristicFormatTypeConversionException  //FIXME:  New exception
		{
			...
			switch (this)
			{
				...
				case GCFT_struct:
				{
					...
					byte result[] = Utils_String.hexStringToBytes(s);
					return result;
				}
			}
	...
	public enum GATTDisplayType
	{
		...
		public String toString(byte data[])
		{
			...
			{
				case Boolean:
					Boolean b = Utils_Byte.byteToBool(data[0]);
					return b.toString();
				case Bitfield:
					return Utils_String.bytesToBinaryString(data, 1);  //TODO:  Size restriction?  For some bit fields we may only want 2 or 4 bits...
				...
				case Hex:
					return "0x" + Utils_String.bytesToHexString(data);
			}
			return null;
		};
		...
		public Object stringToObject(String s)
		{
			switch (this)
			{
				...
				case Bitfield:
					try
					{
						return Utils_String.binaryStringToBytes(s);
					}
					catch (Exception e)
					{
						return null;
				...
				case Hex:
					...
					return Utils_String.hexStringToBytes(s);
			}
		...
		/*public byte[] stringToByteArray(String s)
		{
			...
			switch (this)
			{
				case Boolean:
					...
					break;
				case Bitfield:
					result = Utils.binaryStringToBytes(s);
					break;
				case UnsignedInteger:
				case SignedInteger:
					Long l = Long.valueOf(s);
					result = Utils.longToBytes(l);
					break;
				case Decimal:
