...
<b>|</b>&nbsp;<a href="https://api.sweetblue.io">JavaDocs</a>
<b>|</b>&nbsp;<a href="https://play.google.com/store/apps/details?id=com.idevicesinc.sweetblue.toolbox.v3">Toolbox</a>
<a href="https://travis-ci.org/iDevicesInc/SweetBlue">
  <img align="right" src="https://img.shields.io/badge/version-4.0.0.5_SNAPSHOT-blue.svg" />
</a>
<p align="center">
  <br>
  <a href="https://sweetblue.io">
    <img src="https://7266d0e3ca1c2bdbdd5b-0619b66a775cf8887461031efbbfb2ab.ssl.cf5.rackcdn.com/sweetblue_logo.png" />
  </a>
</p>
...
*	Verbose [logging](https://sweetblue.io/docs/Logging) that outputs human-readable thread IDs, UUIDs, status codes and states instead of alphabet soup.
...
*   Helper class to handle getting required permissions for BLE scanning, along with dialogs, with translated text in 15 languages